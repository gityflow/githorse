...
- [采用 Docker 部署](https://github.com/gityflow/gityflow/tree/master/docker)
...
- 您可以通过查看 [贡献者页面](https://github.com/gityflow/gityflow/graphs/contributors) 获取 TOP 100 的贡献者列表。
- 您可以通过查看 [TRANSLATORS](conf/locale/TRANSLATORS) 文件获取公开的翻译人员列表。

## 授权许可

本项目采用 MIT 开源授权许可证，完整的授权说明已放置在 [LICENSE](https://github.com/gityflow/gityflow/blob/master/LICENSE) 文件中。
