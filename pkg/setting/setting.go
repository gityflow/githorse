...
import (
	...
	"github.com/gityflow/githorse/pkg/user"
)
...
func getOpenSSHVersion() string {
	...
	// Trim unused information: https://github.com/gityflow/githorse/issues/4507#issuecomment-305150441
...
func NewContext() {
	...
	AppName = Cfg.Section("").Key("APP_NAME").MustString("GityFlow")
	...
	// Windows server and OpenSSH version lower than 5.1 (https://github.com/gityflow/githorse/issues/4507)
